...
// Sửa các kiểu dữ liệu Float thành Decimal một cách chính xác
...
// Sửa lỗi cụ thể cho ProductVariant
schema = schema.replace(/price\s+Decimal\s+@db\.Decimal\(12,\s+2\)\?/g, 'price         Decimal? @db.Decimal(12, 2)');

// Ghi file mới
fs.writeFileSync('prisma/schema.prisma', schema);

console.log('✅ Đã sửa schema cho MySQL!');
